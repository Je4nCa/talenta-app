...
- ✅ `Gastos`: 3 tabs — Variables (por mes), Fijos (recurrentes, pausar/reactivar) y **Categorías** (ver detalle abajo). `src/modules/finances/components/FormularioGasto.tsx` y `FormularioGastoFijo.tsx`.
